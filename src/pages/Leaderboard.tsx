      ...
      <div className="container mx-auto px-4 py-8">
        ...
        {studentProfile?.leetcodeStats && (
          ...
          >
            <Card className="shadow-card">
              <CardHeader>
                <CardTitle>Your Recent LeetCode Activity</CardTitle>
                <p className="text-sm text-muted-foreground">
                  Track your coding progress and consistency
                </p>
              </CardHeader>
              <CardContent>
                <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3 mb-6">
                  <div className="rounded-lg border bg-card px-4 py-3 shadow-sm">
                    ...
                    <div className="text-2xl font-bold">
                      {studentProfile.leetcodeStats.totalSolved || 0}
                    </div>
                  </div>
                  <div className="rounded-lg border bg-card px-4 py-3 shadow-sm">
                    <div className="text-xs uppercase tracking-wide text-muted-foreground mb-1">
                    ...
                    <div className="text-2xl font-bold">
                      {studentProfile.leetcodeStats.streak || 0} days
                    </div>
                  </div>
                  <div className="rounded-lg border bg-card px-4 py-3 shadow-sm">
                    <div className="text-xs uppercase tracking-wide text-muted-foreground mb-1">
                    ...
                    <div className="text-2xl font-bold">
                      {studentProfile.leetcodeStats.recentActivity?.last7Days || 0}
                    </div>
                  </div>
                  <div className="rounded-lg border bg-card px-4 py-3 shadow-sm">
                    <div className="text-xs uppercase tracking-wide text-muted-foreground mb-1">
                    ...
                    <div className="text-2xl font-bold">
                      {studentProfile.leetcodeStats.recentActivity?.last30Days || 0}
                    </div>
                  </div>
                  <div className="rounded-lg border bg-card px-4 py-3 shadow-sm">
                    <div className="text-xs uppercase tracking-wide text-muted-foreground mb-1">
                    ...
                    <div className="text-2xl font-bold text-green-500">
                      {studentProfile.leetcodeStats.easy || 0}
                    </div>
                  </div>
                  <div className="rounded-lg border bg-card px-4 py-3 shadow-sm">
                    <div className="text-xs uppercase tracking-wide text-muted-foreground mb-1">
                    ...
                    <div className="text-2xl font-bold text-yellow-500">
                      {studentProfile.leetcodeStats.medium || 0}
                    </div>
                  </div>
                  <div className="rounded-lg border bg-card px-4 py-3 shadow-sm">
                    <div className="text-xs uppercase tracking-wide text-muted-foreground mb-1">
                    ...
                    <div className="text-2xl font-bold text-red-500">
                      {studentProfile.leetcodeStats.hard || 0}
                    </div>
                  </div>
                  {studentProfile.leetcodeStats.activeDays && (
                    <div className="rounded-lg border bg-card px-4 py-3 shadow-sm">
                      <div className="text-xs uppercase tracking-wide text-muted-foreground mb-1">
                        Active Days
                      </div>
                  ...
                  {studentProfile.leetcodeStats.bestDay && (
                    <div className="rounded-lg border bg-card px-4 py-3 shadow-sm">
                      <div className="text-xs uppercase tracking-wide text-muted-foreground mb-1">
                        Best Day
                      </div>
                      <div className="text-lg font-bold">
                        {studentProfile.leetcodeStats.bestDay.count} problems
                      </div>
                      <div className="text-xs text-muted-foreground">
                        {new Date(studentProfile.leetcodeStats.bestDay.date).toLocaleDateString()}
                      </div>
                    </div>
                  )}
                </div>

                {studentProfile.leetcodeStats.topDomains && studentProfile.leetcodeStats.topDomains.length > 0 && (
                  <div className="mt-6">
                    <h4 className="text-sm font-semibold mb-3">Top Problem Domains</h4>
                    <div className="grid gap-2 sm:grid-cols-2">
                      {studentProfile.leetcodeStats.topDomains.slice(0, 6).map((domain: any, idx: number) => (
                        <div
                          key={idx}
